...
LOG_FILE="${LOG_DIR}/orbbec_bgrd_${TIMESTAMP}.log"
...
if [ ! -f "$MASK_PATH" ]; then
    ...
    echo "Running orbbec_bgrd without mask. Output will be saved to: $LOG_FILE"
    /data/qiufangzhou/robot/ORB_SLAM3/Examples/RGB-D/orbbec_bgrd \
        /data/public/datasets/tactile/anyskin_hand2/slam/orbbec.h5 \
        /data/qiufangzhou/robot/ORB_SLAM3/Vocabulary/ORBvoc.txt \
        /data/qiufangzhou/robot/ORB_SLAM3/Examples/RGB-D/orbbec.yaml \
        > "$LOG_FILE" 2>&1
else
    # 带mask参数运行
    echo "Running orbbec_bgrd with mask: $MASK_PATH. Output will be saved to: $LOG_FILE"
    /data/qiufangzhou/robot/ORB_SLAM3/Examples/RGB-D/orbbec_bgrd \
        /data/public/datasets/tactile/anyskin_hand2/slam/orbbec.h5 \
        /data/qiufangzhou/robot/ORB_SLAM3/Vocabulary/ORBvoc.txt \
        /data/qiufangzhou/robot/ORB_SLAM3/Examples/RGB-D/orbbec.yaml \
