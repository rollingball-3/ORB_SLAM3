...
public:
    ...
    // Constructor for RGB-D cameras with mask.
    ...
    // Extract ORB with mask. 0 for left image and 1 for right image.
    void ExtractORBWithMask(int flag, const cv::Mat &im, const cv::Mat &mask, const int x0, const int x1);
